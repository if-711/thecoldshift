...
export const sources: Source[] = [
  ...
  },
  {
    ...
    pmid: '19779735',
    title: 'Do sessions of cryostimulation have influence on white blood cell count, level of IL6 and total oxidative and antioxidative status in healthy men?',
    ...
    outcomeMeasured: 'White blood cell count, IL-6, total oxidative status, total antioxidative status',
    limitations: 'Whole-body cryostimulation at –130 °C is not comparable to dry cold containment. The study reported increased WBC counts and increased IL-6 after ten sessions. Effect direction and magnitude should not be assumed for other delivery methods.',
