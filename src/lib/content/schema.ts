...
export const sources: Source[] = [
  ...
  },
  {
    ...
    year: 2010,
    studyType: 'other',
    population: 'Thermal manikin in a climatic chamber',
    coldMethod: 'pcm_wearable',
    temperature: 'PCM melting temperatures of 24, 28, and 32 °C with manikin temperatures of 34 and 38 °C',
    duration: 'Measured across the available PCM cooling period',
    outcomeMeasured: 'Cooling rate and duration as functions of temperature gradient, mass, covering area, and latent heat',
    limitations: 'Thermal-manikin research on generic cooling vests in hot conditions. It does not establish The Ice Sack cooling profile or human outcomes.',
    doi: '10.1080/00140130903581649',
    url: 'https://pubmed.ncbi.nlm.nih.gov/20432090/',
  },
  {
...
export const claims: Claim[] = [
  ...
  },
  {
    ...
    statementType: 'research_interpretation',
    evidenceConfidence: 'high',
    sourceIds: ['wilson-skin-cooling-2007', 'jdidi-cold-autonomic-review-2024', 'gao-pcm-vest-2010'],
    evidenceSynthesis: 'The reviewed records use materially different delivery systems: water-perfused skin cooling, water immersion, cryostimulation, and PCM contact. Their exposure parameters and measured responses are not equivalent.',
  ...
  {
    id: 'pcm-cooling-depends-on-system-variables',
    statement: 'For PCM cooling garments, cooling rate and duration depend on variables including temperature gradient, covering area, PCM mass, and latent heat.',
    statementType: 'research_interpretation',
    evidenceConfidence: 'moderate',
    sourceIds: ['gao-pcm-vest-2010'],
    evidenceSynthesis: 'Thermal-manikin testing found that PCM cooling rate varied with temperature gradient and coverage, while cooling duration depended on mass and latent heat.',
    limitations: 'The study evaluated generic PCM cooling vests in hot conditions. Direct Ice Sack testing is required to establish its thermal profile.',
    iceSackApplicability: 'indirect_analogy',
    chapterId: 'system',
    lastReviewDate: '2026-08-01',
    reviewer: 'BHVD editorial primary-record review',
...
export const productFacts: ProductFact[] = [
  ...
  },
  {
    ...
    category: 'Dimensions',
    fact: 'Approximate packed dimensions are 15 by 10 by 5.5 inches',
    source: 'The Ice Sack Origin Edition published specification',
    measurementMethod: 'Production sample measurement record pending',
    measurementDate: '',
    measuredBy: 'BHVD',
    dateVerified: '',
    publicWording: 'Approximate packed size: 15 × 10 × 5.5 in.',
    verificationStatus: 'pending',
  },
  {
    id: 'origin-fit',
