    ...
    <article className="section">
      <div className="container" style={{ maxWidth: 'var(--max-width-prose)' }}>
        <header style={{ marginBottom: 'var(--space-16)' }}>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--color-text-tertiary)' }}>BHVD Practice</span>
          <h1 style={{ marginTop: 'var(--space-3)', marginBottom: 'var(--space-6)' }}>
            A structure for attention, not a proven outcome.
          </h1>
          <p className="text-prose">
            Neuropause is an attention framework developed by BHVD for use during a controlled
            cold session. It organizes attention into three named phases. It is not
            required to use The Ice Sack.
          </p>
        </header>
        ...
        <ChapterFlow currentChapterId="practice" />
      </div>
    </article>
  );
}
