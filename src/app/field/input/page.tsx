      ...
      <div className="container" style={{ maxWidth: 'var(--max-width-prose)' }}>
        ...
        <header style={{ marginBottom: 'var(--space-16)' }}>
          ...
          <p className="text-prose">
            Cold exposure is not one uniform intervention. Water immersion, cryostimulation,
            and designed dry cold systems differ in heat transfer, contact, coverage, duration,
