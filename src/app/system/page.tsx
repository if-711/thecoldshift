...
const systemSequence = [
  ...
  },
  {
    number: '03',
    title: 'Practice',
    body: 'Neuropause provides an attentional format during the session. Session duration and stop conditions are governed by the product instructions for use.',
  },
  {
    number: '04',
    title: 'Exit',
          ...
          <section className="section" aria-labelledby="system-role">
            ...
            >
              ...
              <div className="text-prose">
                <p>
                  Cold is the physical input. Neuropause provides an attentional
